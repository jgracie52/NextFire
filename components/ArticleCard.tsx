...
import { UserButton, UserButtonProps } from './UserInfoButton';
...
export function ArticleCard({
  ...
  return (
    <Card withBorder radius="md" className={cx(classes.card, className)} {...others}>
      <Card.Section>
        <a {...linkProps}>
          <Image src={image || '/cover-placeholder-image.jpg'} height={180} />
        </a>
      </Card.Section>

      <Badge className={classes.rating} variant="gradient" gradient={{ from: 'red', to: 'pink' }}>
        {rating}
      </Badge>
