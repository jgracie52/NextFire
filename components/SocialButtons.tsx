import { Button, ButtonProps, Group, Image } from '@mantine/core';
import { GithubIcon, DiscordIcon, TwitterIcon } from '@mantine/ds';

export function GoogleButton(props: ButtonProps) {
  return <Button leftIcon={'/google.png'} variant="default" color="gray" {...props} />;
}

export function FacebookButton(props: ButtonProps) {
  return (
    <Button
      leftIcon={<Image src='/facebook.png' width={20} />}
      sx={(theme) => ({
